...
export default function Profile() {
  ...
  const handleFileUpload = (file) =>{
    ...
    const uploadTask = uploadBytesResumable(storageRef, file); // to show the upload percentage
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? <span className="text-red-700">Error Image Upload ( must be less than 2MB )</span> 
